...
func _initialize_command_processors():
	...
	var audio_commands = MCPAudioCommands.new()
	var introspection_commands = MCPIntrospectionCommands.new()
	var visualizer_commands = MCPVisualizerCommands.new()
	...
	audio_commands._websocket_server = _websocket_server
	introspection_commands._websocket_server = _websocket_server
	visualizer_commands._websocket_server = _websocket_server
	...
	_command_processors.append(audio_commands)
	_command_processors.append(introspection_commands)
	_command_processors.append(visualizer_commands)
	...
	add_child(audio_commands)
	add_child(introspection_commands)
	add_child(visualizer_commands)
